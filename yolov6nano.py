...
# ONNX_MODEL = '/mnt/mysata1/hc/rknn/rknn-toolkit2/examples/onnx/yolov5/trace.pt'
# RKNN_MODEL = '/mnt/mysata1/hc/rknn/rknn-toolkit2/examples/onnx/yolov5/best_ckpt_relu.rknn'

# IMG_PATH = '/mnt/mysata1/hc/rknn/rknn-toolkit2/examples/onnx/yolov5/driver_2.jpg'
# DATASET = '/mnt/mysata1/hc/rknn/rknn-toolkit2/examples/onnx/yolov5/dataset.txt'
ONNX_MODEL = './best_ckpt_relu.onnx'
RKNN_MODEL = './best_ckpt_relu.rknn'
IMG_PATH = './driver.jpg'
DATASET = './dataset.txt'
QUANTIZE_ON = True
...
if __name__ == '__main__':
    ...
    img = torch.zeros(1, 640, 640, 3).numpy()
    # # Set inputs
    # img = cv2.imread(IMG_PATH)
    # im0 = img.copy()
    # # img, ratio, (dw, dh) = letterbox(img, new_shape=(IMG_SIZE, IMG_SIZE))
        ...
        if len(det):
            ...
            for *xyxy, conf, cls in reversed(det):
                ...
                cv2.putText(im0, '{0} {1:.2f}'.format(CLASSES[int(cls)], conf),
                                                            ...
                                                            0.6, (0, 0, 255), 2)
    # print("classfication result : ",pred1)
    # show output
