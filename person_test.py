...
ONNX_MODEL = '/mnt/mysata1/zgm/rknn/rknn-toolkit2/examples/onnx/yolov5/person_v5_best.onnx'
RKNN_MODEL = '/mnt/mysata1/zgm/rknn/rknn-toolkit2/examples/onnx/yolov5/person_v5_best.rknn'

IMG_PATH = '/mnt/mysata1/zgm/rknn/rknn-toolkit2/examples/onnx/yolov5/person.jpg'
DATASET = '/home/b610/zgm/rknn/rknn-toolkit2/examples/onnx/yolov5/dataset.txt'
...
if __name__ == '__main__':
    ...
    # pre-process config
    print('--> Config model')
    rknn.config(mean_values=[[0, 0, 0]], std_values=[[255, 255, 255]],float_dtype='float16',target_platform="rk3568")
    print('done')
    ...
    img,rate,_ = letterbox(img, (640,640), stride=32)
    img_shape = img.shape
